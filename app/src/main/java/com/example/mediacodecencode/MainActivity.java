...
//    int height = 480;
    ...
    private static volatile int encodeFrameCount;
    ...
    private Thread encodeFrameThread;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        FileUtils.deleteFile("/sdcard/h264/test1.h264");
...
//        avcCodec2 = new AvcEncoder(this.width,this.height,framerate,biterate,"s2");
...
//        encodeFrameCount++;
//        Log.e("AvcEncoder", " encode frameCount: " + encodeFrameCount);

    }

    private void StartFrameThread(){
        if(encodeFrameThread ==null){
            encodeFrameThread = new Thread(new Runnable() {
                @Override
                public void run() {
                    while (true) {
                        Log.e("AvcEncoder", " encode frameCount: " + encodeFrameCount);
